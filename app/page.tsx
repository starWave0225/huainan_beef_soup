...
const siteTabs = [
  ...
  { id: "sources", number: "06", label: "来源资料", note: "视频与100项档案" },
] as const;
    ...
    <main id="top">
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            ...
            <span>100项公开来源 · 8条视频 · 6张开放授权图片</span>
          </div>
        </div>
      ...
      <section className="draft-section page-section" id="draft">
        <div className="essay-shell">
          ...
          <aside className="draft-disclaimer">
            <b>材料范围</b>
            <p>正文以100项公开资料为基础，能够说明政策、媒体和产业主体公开说了什么；涉及本地居民记忆、游客动机和平台接受效果的判断，仍需访谈、抽样或统计验证。</p>
          </aside>
          ...
          <article className="essay-chapter">
            ...
            <div className="essay-prose">
              ...
              <section className="essay-subsection" id="essay-intro-methods">
                ...
                <p><b>公开资料库承担“重建事件与提出命题”的作用。</b>当前100项来源包括政策统计、新闻专题、8条可观看视频、学术与典籍、开放授权图片。研究将它们按发布者、日期、材料类型、核心说法、证据强度和可用于哪一章登记，并保存标题、网址与关键内容。公开资料能够确认某项政策何时发布、节目展示了什么、机构使用了哪些数字，却不能直接代表受众想法。因此，本文把可核事实、机构公开口径、地方传说和研究推断分开标注；前期资料只用来建立事件链和研究假设，不冒充完整样本。</p>
      ...
      <section className="methods-lab page-section" id="methods">
        <div className="section-heading">
          ...
          <p>网站里的100项公开来源只是前期材料，不能代替你自己的调查。下面这套办法既能写进研究方法章节，也确实可以照着执行。</p>
        </div>
        ...
        <div className="corpus-grid">
          <article><span>A · 政策、新闻和研究资料</span><h3>网站现有100项</h3><p>用来整理政策节点、事件时间线、理论和图片。要保存标题、日期、发布者、网址、关键段落和授权信息，防止原链接以后失效。</p></article>
      ...
      <section className="sources-section page-section" id="sources">
        <div className="section-heading">
          <div><p className="section-kicker">所有材料都放在这里</p><h2>100项网页、文章、视频、图片和学术资料。</h2></div>
      ...
      <section className="method-section page-section">
        ...
        <div className="method-grid">
          <article><h3>这个网站已经做了什么</h3><p>100项政策、统计、新闻、视频、图片、典籍和学术资料都已逐条登记。开放图片记录了作者和许可证，论文各章也配好了可以使用的材料和不能说过头的地方。</p></article>
